...
<head>
    ...
    ?>
<title>Jeclat '11 IRINA | Contact Us</title>
</head>
                                    	...
                                    	<table class="text-normal" border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                                        	<tr>
                                            	<td>
                                                    ...
                                                    <style> #mainmenu_contactus { color:#FFBBAA; font-weight: 700; } </style>
                                          		</td>
                                          	</tr>
                                            <tr>
                                            	<td height="10px"></td>
                                            ...
                                            <tr>
                                            	<td>
                                                	<span id="span_location_text">
                                                        ...
                                                        &middot; 
                                                        <a class="locator-link" href="#">Contact Us</a>
                                                    </span>
                                          		</td>
                                          	</tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td class="td-border-c">
                                    	<table class="text-normal" border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                                        	<tr>
                                            	<td>
                                                	<?php require_once('jclt-page-content-contactus.php'); ?>
                                          		</td>
                                          	</tr>
                                        </table>
                                    </td>
