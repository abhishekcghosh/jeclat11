...
{
	jclt_event_changeTo(document.getElementById("lastDisplayedContent").value,'Event List');
}
function jclt_event_changeTo(eventid,eventName)
{
	...
	document.getElementById("span_event_in_navigator").innerHTML='&middot;&nbsp;<a class="locator-link" href="?e='+eventid+'">'+eventName+'</a>';
}
